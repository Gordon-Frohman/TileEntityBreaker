    ...
    THAUMCRAFT_COMPAT(
        new Builder("Bypass stupid Thaumcraft rendering system to allow breaking textures to render properly")
            ...
            .addMixinClasses(
                addPrefix(
                    "thaumcraft.",
                    "MixinBlockTubeRenderer",
                    "MixinRenderGlobal",
                    "MixinTileAlchemyFurnaceAdvancedRenderer",
                    "MixinTileAlembicRenderer",
                    "MixinTileArcaneBoreBaseRenderer",
                    "MixinTileArcaneBoreRenderer",
                    "MixinTileArcaneWorkbenchRenderer",
                    "MixinTileBannerRenderer",
                    "MixinTileBellowsRenderer",
                    "MixinTileCentrifugeRenderer",
                    "MixinTileChestHungryRenderer",
                    "MixinTileCrystalRenderer",
                    "MixinTileDeconstructionTableRenderer",
                    "MixinTileEldritchCapRenderer",
                    "MixinTileEldritchCrabSpawnerRenderer",
                    "MixinTileEldritchCrystalRenderer",
                    "MixinTileEldritchObeliskRenderer",
                    "MixinTileEssentiaCrystalizerRenderer",
                    "MixinTileEssentiaReservoirRenderer",
                    "MixinTileFluxScrubberRenderer",
                    "MixinTileFocalManipulatorRenderer",
                    "MixinTileInfusionPillarRenderer",
                    "MixinTileMagicWorkbenchChargerRenderer",
                    "MixinTileManaPodRenderer",
                    "MixinTileNodeConverterRenderer",
                    "MixinTileNodeStabilizerRenderer",
                    "MixinTileResearchTableRenderer",
                    "MixinTileRunicMatrixRenderer",
                    "MixinTileTableRenderer",
                    "MixinTileThaumatoriumRenderer",
                    "MixinTileVisRelayRenderer"))),
