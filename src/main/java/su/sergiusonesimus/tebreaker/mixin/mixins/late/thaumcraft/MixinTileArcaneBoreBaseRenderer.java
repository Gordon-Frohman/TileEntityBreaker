...
@Mixin(TileArcaneBoreBaseRenderer.class)
public class MixinTileArcaneBoreBaseRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderEntityAt(Lthaumcraft/common/tiles/TileArcaneBoreBase;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
