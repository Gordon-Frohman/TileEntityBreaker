...
@Mixin(TileCentrifugeRenderer.class)
public class MixinTileCentrifugeRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderEntityAt(Lthaumcraft/common/tiles/TileCentrifuge;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
