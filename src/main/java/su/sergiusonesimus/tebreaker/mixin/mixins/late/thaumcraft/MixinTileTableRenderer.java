...
@Mixin(TileTableRenderer.class)
public class MixinTileTableRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderTileEntityAt(Lthaumcraft/common/tiles/TileTable;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
