...
@Mixin(TileVisRelayRenderer.class)
public class MixinTileVisRelayRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderTileEntityAt(Lthaumcraft/common/tiles/TileVisRelay;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
