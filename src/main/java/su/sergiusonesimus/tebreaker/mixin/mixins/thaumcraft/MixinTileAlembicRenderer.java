...
@Mixin(TileAlembicRenderer.class)
public class MixinTileAlembicRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderTileEntityAt(Lthaumcraft/common/tiles/TileAlembic;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
