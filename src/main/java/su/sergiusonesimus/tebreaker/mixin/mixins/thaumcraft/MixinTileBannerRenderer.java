...
@Mixin(TileBannerRenderer.class)
public class MixinTileBannerRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderTileEntityAt(Lthaumcraft/common/tiles/TileBanner;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
