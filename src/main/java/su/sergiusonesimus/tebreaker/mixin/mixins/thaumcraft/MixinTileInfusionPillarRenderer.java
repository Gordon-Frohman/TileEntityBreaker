...
@Mixin(TileInfusionPillarRenderer.class)
public class MixinTileInfusionPillarRenderer extends MixinTileEntitySpecialRenderer {

    @WrapOperation(
        method = "renderTileEntityAt(Lthaumcraft/common/tiles/TileInfusionPillar;DDDF)V",
        remap = false,
        at = @At(
            value = "INVOKE",
